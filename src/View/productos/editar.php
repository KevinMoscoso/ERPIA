<?php
/** @var \Erpia\Model\Producto $producto */
/** @var array $errors */
...
<head>
    <meta charset="utf-8">
    <title>Editar producto - ERP-IA</title>
...
<div class="container my-4">
    ...
    <form action="/productos/actualizar/<?= htmlspecialchars((string) $producto->id, ENT_QUOTES, 'UTF-8') ?>" method="post" novalidate>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea
                ...
                rows="3"
                required
            ><?= htmlspecialchars($producto->descripcion, ENT_QUOTES, 'UTF-8') ?></textarea>
        ...
        <div class="mb-3">
            ...
            <input
                ...
                id="precio"
                name="precio"
                value="<?= htmlspecialchars(number_format($producto->precio, 2, '.', ''), ENT_QUOTES, 'UTF-8') ?>"
                required
            >
        ...
        <div class="mb-3">
            ...
            <input
                ...
                id="stock"
                name="stock"
                value="<?= htmlspecialchars((string) $producto->stock, ENT_QUOTES, 'UTF-8') ?>"
                required
            >
