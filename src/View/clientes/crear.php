...
<head>
    <meta charset="utf-8">
    <title>Crear cliente - ERP-IA</title>
...
<div class="container my-4">
    <h1 class="h3 mb-3">Crear cliente</h1>
    ...
    <form action="/clientes/guardar" method="post" novalidate>
        ...
        <div class="mb-3">
            ...
            <textarea name="direccion" class="form-control"><?= htmlspecialchars((string) ($old['direccion'] ?? ''), ENT_QUOTES, 'UTF-8') ?></textarea>
        </div>
